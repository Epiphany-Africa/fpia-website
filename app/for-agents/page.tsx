      ...
      <main>
        ...
        <section className="bg-[#0B1F33] px-5 py-16 sm:px-8 md:py-24">
          <div className="max-w-4xl mx-auto">
            <p className="text-[#C9A14D] text-xs tracking-widest uppercase mb-4">For Property Practitioners</p>
        ...
        <section className="bg-[#f5f0e8] px-5 py-16 sm:px-8 md:py-24">
          <div className="max-w-4xl mx-auto">
            <p className="text-[#C9A14D] text-xs tracking-widest uppercase mb-4">Built for Property Practitioners</p>
            ...
            <div className="space-y-12">
              {[
                ...
                { num: '04', title: 'Build a Trusted Brand', body: 'Property practitioners who consistently use FPIA build a reputation for professionalism. Referrals follow transparency.' },
              ].map((item) => (
        ...
        <section className="bg-[#0B1F33] px-5 py-16 text-center sm:px-8 md:py-24">
          ...
          <p className="text-gray-400 mb-10">Register as a property practitioner partner and start certifying your listings today.</p>
